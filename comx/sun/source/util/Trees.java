...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("comx.sun.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("comx.sun.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("comx.sun.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("comx.sun.tools.javac.api.JavacTrees", false, cl);
