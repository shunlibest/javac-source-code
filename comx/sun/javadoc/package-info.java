...
The invocation is defined by the abstract {@link comx.sun.javadoc.Doclet} class
-- the entry point is the {@link comx.sun.javadoc.Doclet#start(RootDoc) start} method:
<pre>
    public static boolean <b>start</b>(RootDoc root)
</pre>
The {@link comx.sun.javadoc.RootDoc} instance holds the root of the program structure
...
{@link comx.sun.javadoc.PackageDoc#allClasses(boolean) allClasses(false)}.)
<p>

<a name="class"></a>
Throughout this API, the term <em>class</em> is normally a
shorthand for "class or interface", as in: {@link comx.sun.javadoc.ClassDoc},
{@link comx.sun.javadoc.PackageDoc#allClasses() allClasses()}, and
{@link comx.sun.javadoc.PackageDoc#findClass(String) findClass(String)}.
In only a couple of other places, it means "class, as opposed to interface",
as in:  {@link comx.sun.javadoc.Doc#isClass()}.
In the second sense, this API calls out four kinds of classes:
{@linkplain comx.sun.javadoc.Doc#isOrdinaryClass() ordinary classes},
{@linkplain comx.sun.javadoc.Doc#isEnum() enums},
{@linkplain comx.sun.javadoc.Doc#isError() errors} and
{@linkplain comx.sun.javadoc.Doc#isException() exceptions}.
...
{@link comx.sun.javadoc.Doclet Doclet} is an abstract class that specifies
the invocation interface for doclets,
{@link comx.sun.javadoc.Doclet Doclet} holds class or interface information,
{@link comx.sun.javadoc.ExecutableMemberDoc} is a
superinterface of {@link comx.sun.javadoc.MethodDoc} and
{@link comx.sun.javadoc.ConstructorDoc},
and {@link comx.sun.javadoc.ParamTag} holds information
...
@see comx.sun.javadoc.Doclet
@see comx.sun.javadoc.RootDoc
*/
@jdk.Exported
package comx.sun.javadoc;
