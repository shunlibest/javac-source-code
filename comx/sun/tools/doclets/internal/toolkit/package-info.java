...
/**
    ...
    <ul>
        <li>
            ...
            {@link comx.sun.tools.doclets.internal.toolkit.AbstractDoclet}.
        </li>
        <li>
            The doclet configuration class should extend
            {@link comx.sun.tools.doclets.internal.toolkit.Configuration}.
        </li>
        <li>
            The doclet should have a writer factory that implements
            {@link comx.sun.tools.doclets.internal.toolkit.WriterFactory}.
            This class constructs writers that write doclet specific output.
        </li>
        <li>
            The doclet should have a taglet writer that extends
            {@link comx.sun.tools.doclets.internal.toolkit.taglets.TagletWriter}.
