...
public class TagletManager {
    ...
    private void checkTaglet(Object taglet) {
        ...
        } else if (taglet instanceof comx.sun.tools.doclets.Taglet) {
            comx.sun.tools.doclets.Taglet legacyTaglet = (comx.sun.tools.doclets.Taglet) taglet;
    ...
    private void initStandardTaglets() {
        ...
        // See, for example, comx.sun.tools.javadoc.Comment
