...
package comx.sun.tools.doclets.formats.html.markup;

import java.io.*;
import java.util.*;

import comx.sun.javadoc.*;
import comx.sun.tools.doclets.formats.html.ConfigurationImpl;
import comx.sun.tools.doclets.formats.html.SectionName;
import comx.sun.tools.doclets.internal.toolkit.*;
import comx.sun.tools.doclets.internal.toolkit.util.DocFile;
import comx.sun.tools.doclets.internal.toolkit.util.DocLink;
import comx.sun.tools.doclets.internal.toolkit.util.DocPath;


/**
 * Class for the Html Format Code Generation specific to JavaDoc.
 * This Class contains methods related to the Html Code Generation which
 * are used by the Sub-Classes in the package comx.sun.tools.doclets.standard
 * and comx.sun.tools.doclets.oneone.
 *
