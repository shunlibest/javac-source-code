...
import comx.sun.tools.sjavac.server.JavacServer;
...
public class Main {
    ...
    /*  This is a smart javac wrapper primarily used when building the OpenJDK,
        ...
        ** Create a state file, containing information about the build, so
           ...
           SJAVAC=java -cp .../tools.jar comx.sun.tools.sjavac.Main
        ...
        ** Basic translation support from other sources to java, and then compilation of the generated java.
           ...
           "-copy .gif"
           "-copy META-INF"
           "-tr .prop=comx.sun.tools.javac.smart.CompileProperties
           "-tr .propp=comx.sun.tools.javac.smart.CompileProperties,java.util.ListResourceBundle
           "-tr .proppp=comx.sun.tools.javac.smart.CompileProperties,sun.util.resources.LocaleNamesBundle
        ...
        ** The smart javac wrapper is driven by the modification time on the source files and compared
        ...
        The command line:
        java -cp tools.jar comx.sun.tools.sjavac.Main \
...
//          findFiles(args, "-modulepath", Util.set(".class"), modules_to_link_to, modules, current_module, true);
    ...
    private static void checkTranslatePattern(String s) throws ProblemException {
        // .prop=comx.sun.tools.javac.smart.CompileProperties
        // .idl=comx.sun.corba.CompileIdl
