...
import comx.sun.tools.sjavac.Util;
import comx.sun.tools.sjavac.ProblemException;
import java.io.*;
import java.util.*;
...
public class JavacServer {
    ...
    public static int useServer(String settings, String[] args,
        ...
        try {
            ...
            // to point to a comx.sun.tools.sjavac.Main that supports --startserver
            // for example by setting: sjavac=java%20-jar%20...javac.jar%comx.sun.tools.sjavac.Main
