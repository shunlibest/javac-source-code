...
package comx.sun.tools.sjavac.server;
...
import comx.sun.tools.javac.main.Main;
import comx.sun.tools.javac.util.Context;
import comx.sun.tools.javac.util.Log;
import comx.sun.tools.javac.util.BaseFileManager;
import comx.sun.tools.sjavac.comp.Dependencies;
import comx.sun.tools.sjavac.comp.JavaCompilerWithDeps;
import comx.sun.tools.sjavac.comp.SmartFileManager;
import comx.sun.tools.sjavac.comp.ResolveWithDeps;
...
public class CompilerThread implements Runnable {
    ...
    private comx.sun.tools.javac.api.JavacTool compiler;
    ...
    public synchronized void use() {
        assert(!inUse);
        inUse = true;
        compiler = comx.sun.tools.javac.api.JavacTool.create();
    ...
    public void run() {
        ...
        try {
            ...
            comx.sun.tools.javac.util.ListBuffer<JavaFileObject> compilationUnits =
                new comx.sun.tools.javac.util.ListBuffer<JavaFileObject>();
            for (JavaFileObject i : fileManager.getJavaFileObjectsFromFiles(the_classes)) {
                compilationUnits.append(i);
            }
            // Now deal with sources supplied as source_to_compile.
            comx.sun.tools.javac.util.ListBuffer<File> sourcesToCompileFiles =
                new comx.sun.tools.javac.util.ListBuffer<File>();
            ...
            try {
                if (compilationUnits.size() > 0) {
                    ...
                    // Process the options.
                    comx.sun.tools.javac.api.JavacTool.processOptions(context, smartFileManager, the_options);
                    ...
                    Main ccompiler = new Main("javacTask", stderr);
