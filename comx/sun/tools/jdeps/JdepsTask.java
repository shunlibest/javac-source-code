...
import comx.sun.tools.classfile.Dependencies;
import comx.sun.tools.classfile.Dependencies.ClassFileError;
import comx.sun.tools.classfile.Dependency;
import comx.sun.tools.jdeps.PlatformClassPath.JDKArchive;
import java.io.*;
...
class JdepsTask {
    ...
    private static class ResourceBundleHelper {
        ...
        static {
            ...
            try {
                bundle = ResourceBundle.getBundle("comx.sun.tools.jdeps.resources.jdeps", locale);
            } catch (MissingResourceException e) {
                throw new InternalError("Cannot find jdeps resource bundle for locale " + locale);
            }
            try {
                versionRB = ResourceBundle.getBundle("comx.sun.tools.jdeps.resources.version");
            } catch (MissingResourceException e) {
