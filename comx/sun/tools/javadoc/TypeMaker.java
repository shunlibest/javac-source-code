...
import static comx.sun.tools.javac.code.TypeTag.ARRAY;
...
public class TypeMaker {
    ...
    public static comx.sun.javadoc.Type getType(DocEnv env, Type t) {
     ...
     */
    public static comx.sun.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new comx.sun.javadoc.Type[ts.length()]);
    }
    ...
    private static class ArrayTypeImpl implements comx.sun.javadoc.Type {
