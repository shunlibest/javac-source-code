...
package comx.sun.tools.javadoc;
...
import comx.sun.tools.javac.code.TypeTag;
import comx.sun.tools.javac.comp.AttrContext;
import comx.sun.tools.javac.comp.Env;
import comx.sun.tools.javac.tree.JCTree;
import comx.sun.tools.javac.tree.JCTree.JCFieldAccess;
import comx.sun.tools.javac.tree.JCTree.JCImport;
...
import static comx.sun.tools.javac.code.TypeTag.CLASS;
...
public class ClassDocImpl extends ProgramElementDocImpl implements ClassDoc {
    ...
    public comx.sun.javadoc.Type getElementType() {
        return null;
    }
     ...
     */
    public comx.sun.javadoc.Type superclassType() {
     ...
     * Return an empty array if there are no interfaces.
     */
    public comx.sun.javadoc.Type[] interfaceTypes() {
        //### Cache result here?
