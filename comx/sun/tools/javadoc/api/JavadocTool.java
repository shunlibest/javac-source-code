...
package comx.sun.tools.javadoc.api;
...
import comx.sun.tools.javac.api.ClientCodeWrapper;
...
import comx.sun.tools.javadoc.ToolOption;
...
public class JavadocTool implements DocumentationTool {
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        try {
            String standardDocletName = "comx.sun.tools.doclets.standard.Standard";
            ClassLoader cl = getClass().getClassLoader();
            return comx.sun.tools.javadoc.Main.execute(
