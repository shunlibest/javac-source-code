...
//                throw new BadArgs("jni.no.stubs");
    ...
    private static final String versionRBName = "comx.sun.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("comx.sun.tools.javah.resources.l10n", locale);
