...
package comx.sun.tools.javac.api;
...
import comx.sun.source.doctree.DocCommentTree;
import comx.sun.source.doctree.DocTree;
import comx.sun.source.tree.CatchTree;
import comx.sun.source.tree.CompilationUnitTree;
import comx.sun.source.tree.Scope;
import comx.sun.source.tree.Tree;
import comx.sun.source.util.DocSourcePositions;
import comx.sun.source.util.DocTreePath;
import comx.sun.source.util.DocTreeScanner;
import comx.sun.source.util.DocTrees;
import comx.sun.source.util.JavacTask;
import comx.sun.source.util.TreePath;
import comx.sun.tools.javac.code.Flags;
import comx.sun.tools.javac.code.Kinds;
import comx.sun.tools.javac.code.Symbol;
import comx.sun.tools.javac.code.Symbol.ClassSymbol;
import comx.sun.tools.javac.code.Symbol.MethodSymbol;
import comx.sun.tools.javac.code.Symbol.PackageSymbol;
import comx.sun.tools.javac.code.Symbol.TypeSymbol;
import comx.sun.tools.javac.code.Symbol.VarSymbol;
import comx.sun.tools.javac.code.Type;
import comx.sun.tools.javac.code.Type.ArrayType;
import comx.sun.tools.javac.code.Type.ClassType;
import comx.sun.tools.javac.code.Type.ErrorType;
import comx.sun.tools.javac.code.Type.UnionClassType;
import comx.sun.tools.javac.code.Types;
import comx.sun.tools.javac.code.Types.TypeRelation;
import comx.sun.tools.javac.comp.Attr;
import comx.sun.tools.javac.comp.AttrContext;
import comx.sun.tools.javac.comp.Enter;
import comx.sun.tools.javac.comp.Env;
import comx.sun.tools.javac.comp.MemberEnter;
import comx.sun.tools.javac.comp.Resolve;
import comx.sun.tools.javac.model.JavacElements;
import comx.sun.tools.javac.processing.JavacProcessingEnvironment;
import comx.sun.tools.javac.tree.DCTree;
import comx.sun.tools.javac.tree.DCTree.DCBlockTag;
import comx.sun.tools.javac.tree.DCTree.DCDocComment;
import comx.sun.tools.javac.tree.DCTree.DCEndPosTree;
import comx.sun.tools.javac.tree.DCTree.DCErroneous;
import comx.sun.tools.javac.tree.DCTree.DCIdentifier;
import comx.sun.tools.javac.tree.DCTree.DCParam;
import comx.sun.tools.javac.tree.DCTree.DCReference;
import comx.sun.tools.javac.tree.DCTree.DCText;
import comx.sun.tools.javac.tree.EndPosTable;
import comx.sun.tools.javac.tree.JCTree;
import comx.sun.tools.javac.tree.JCTree.*;
import comx.sun.tools.javac.tree.TreeCopier;
import comx.sun.tools.javac.tree.TreeInfo;
import comx.sun.tools.javac.tree.TreeMaker;
import comx.sun.tools.javac.util.Abort;
import comx.sun.tools.javac.util.Assert;
import comx.sun.tools.javac.util.Context;
import comx.sun.tools.javac.util.JCDiagnostic;
import comx.sun.tools.javac.util.List;
import comx.sun.tools.javac.util.ListBuffer;
import comx.sun.tools.javac.util.Log;
import comx.sun.tools.javac.util.Name;
import comx.sun.tools.javac.util.Names;
import comx.sun.tools.javac.util.Pair;
import comx.sun.tools.javac.util.Position;
import static comx.sun.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (comx.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see comx.sun.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (comx.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see comx.sun.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see comx.sun.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        comx.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see comx.sun.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof comx.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (comx.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof comx.sun.tools.javac.code.Type.ErrorType) {
            return ((comx.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return comx.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            comx.sun.source.tree.Tree t,
            comx.sun.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            comx.sun.source.doctree.DocTree t,
            comx.sun.source.doctree.DocCommentTree c,
            comx.sun.source.tree.CompilationUnitTree root) {
