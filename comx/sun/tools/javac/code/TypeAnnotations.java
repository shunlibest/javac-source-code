...
package comx.sun.tools.javac.code;
...
import comx.sun.tools.javac.code.Attribute.TypeCompound;
import comx.sun.tools.javac.code.Type.AnnotatedType;
import comx.sun.tools.javac.code.Type.ArrayType;
import comx.sun.tools.javac.code.Type.CapturedType;
import comx.sun.tools.javac.code.Type.ClassType;
import comx.sun.tools.javac.code.Type.ErrorType;
import comx.sun.tools.javac.code.Type.ForAll;
import comx.sun.tools.javac.code.Type.MethodType;
import comx.sun.tools.javac.code.Type.PackageType;
import comx.sun.tools.javac.code.Type.TypeVar;
import comx.sun.tools.javac.code.Type.UndetVar;
import comx.sun.tools.javac.code.Type.Visitor;
import comx.sun.tools.javac.code.Type.WildcardType;
import comx.sun.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import comx.sun.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
import comx.sun.tools.javac.code.Symbol.VarSymbol;
import comx.sun.tools.javac.code.Symbol.MethodSymbol;
import comx.sun.tools.javac.comp.Annotate;
import comx.sun.tools.javac.comp.Annotate.Worker;
...
import comx.sun.tools.javac.tree.JCTree.JCBlock;
import comx.sun.tools.javac.tree.JCTree.JCClassDecl;
import comx.sun.tools.javac.tree.JCTree.JCExpression;
import comx.sun.tools.javac.tree.JCTree.JCLambda;
import comx.sun.tools.javac.tree.JCTree.JCMethodDecl;
import comx.sun.tools.javac.tree.JCTree.JCMethodInvocation;
import comx.sun.tools.javac.tree.JCTree.JCNewClass;
import comx.sun.tools.javac.tree.JCTree.JCTypeApply;
import comx.sun.tools.javac.tree.JCTree.JCVariableDecl;
import comx.sun.tools.javac.tree.TreeScanner;
import comx.sun.tools.javac.tree.JCTree.*;
...
import comx.sun.tools.javac.util.Options;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link comx.sun.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
        ...
        private Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                // UnionClassType uct = (comx.sun.tools.javac.code.Type.UnionClassType)type;
        ...
        private void resolveFrame(JCTree tree, JCTree frame,
            ...
            */
            ...
            // comx.sun.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
