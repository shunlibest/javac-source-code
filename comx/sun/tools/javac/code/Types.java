...
import comx.sun.tools.javac.code.Attribute.RetentionPolicy;
...
import comx.sun.tools.javac.comp.Check;
import comx.sun.tools.javac.comp.Enter;
import comx.sun.tools.javac.comp.Env;
import comx.sun.tools.javac.jvm.ClassReader;
import comx.sun.tools.javac.util.*;
import static comx.sun.tools.javac.code.BoundKind.*;
import static comx.sun.tools.javac.code.Flags.*;
import static comx.sun.tools.javac.code.Scope.*;
import static comx.sun.tools.javac.code.Symbol.*;
import static comx.sun.tools.javac.code.Type.*;
import static comx.sun.tools.javac.code.TypeTag.*;
import static comx.sun.tools.javac.jvm.ClassFile.externalize;
