...
*/
// Code duplicated in comx.sun.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In comx.sun.tools.javac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in comx.sun.tools.javac.jvm.Code.fillExceptionParameterPositions
