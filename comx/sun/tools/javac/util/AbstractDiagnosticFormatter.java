 ...
 * questions.
 */
package comx.sun.tools.javac.util;
...
import comx.sun.tools.javac.api.DiagnosticFormatter;
import comx.sun.tools.javac.api.DiagnosticFormatter.Configuration.DiagnosticPart;
import comx.sun.tools.javac.api.DiagnosticFormatter.Configuration.MultilineLimit;
import comx.sun.tools.javac.api.DiagnosticFormatter.PositionKind;
import comx.sun.tools.javac.api.Formattable;
import comx.sun.tools.javac.code.Lint.LintCategory;
import comx.sun.tools.javac.code.Printer;
...
import comx.sun.tools.javac.file.BaseFileObject;
import comx.sun.tools.javac.jvm.Profile;
import comx.sun.tools.javac.tree.JCTree.*;
import comx.sun.tools.javac.tree.Pretty;
import static comx.sun.tools.javac.util.JCDiagnostic.DiagnosticType.*;
