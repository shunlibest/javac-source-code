...
import comx.sun.source.tree.IdentifierTree;
import comx.sun.source.tree.MemberReferenceTree.ReferenceMode;
import comx.sun.source.tree.MemberSelectTree;
import comx.sun.source.tree.TreeVisitor;
import comx.sun.source.util.SimpleTreeVisitor;
import comx.sun.tools.javac.code.*;
import comx.sun.tools.javac.code.Lint.LintCategory;
...
import static comx.sun.tools.javac.code.Flags.ANNOTATION;
...
import static comx.sun.tools.javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * comx.sun.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
