...
package comx.sun.tools.javac.comp;

import comx.sun.source.tree.MemberReferenceTree.ReferenceMode;
import comx.sun.tools.javac.api.Formattable.LocalizedString;
import comx.sun.tools.javac.code.*;
import comx.sun.tools.javac.code.Symbol.*;
import comx.sun.tools.javac.code.Type.*;
import comx.sun.tools.javac.comp.Attr.ResultInfo;
import comx.sun.tools.javac.comp.Check.CheckContext;
import comx.sun.tools.javac.comp.DeferredAttr.AttrMode;
import comx.sun.tools.javac.comp.DeferredAttr.DeferredAttrContext;
import comx.sun.tools.javac.comp.DeferredAttr.DeferredType;
import comx.sun.tools.javac.comp.Infer.InferenceContext;
import comx.sun.tools.javac.comp.Infer.FreeTypeListener;
import comx.sun.tools.javac.comp.Resolve.MethodResolutionContext.Candidate;
import comx.sun.tools.javac.comp.Resolve.MethodResolutionDiagHelper.DiagnosticRewriter;
import comx.sun.tools.javac.comp.Resolve.MethodResolutionDiagHelper.Template;
import comx.sun.tools.javac.jvm.*;
import comx.sun.tools.javac.main.Option;
import comx.sun.tools.javac.tree.*;
import comx.sun.tools.javac.tree.JCTree.*;
import comx.sun.tools.javac.tree.JCTree.JCMemberReference.ReferenceKind;
import comx.sun.tools.javac.tree.JCTree.JCPolyExpression.*;
import comx.sun.tools.javac.util.*;
import comx.sun.tools.javac.util.JCDiagnostic.DiagnosticFlag;
import comx.sun.tools.javac.util.JCDiagnostic.DiagnosticPosition;
import comx.sun.tools.javac.util.JCDiagnostic.DiagnosticType;
...
import static comx.sun.tools.javac.code.Flags.*;
import static comx.sun.tools.javac.code.Flags.BLOCK;
import static comx.sun.tools.javac.code.Kinds.*;
import static comx.sun.tools.javac.code.Kinds.ERRONEOUS;
import static comx.sun.tools.javac.code.TypeTag.*;
import static comx.sun.tools.javac.comp.Resolve.MethodResolutionPhase.*;
import static comx.sun.tools.javac.tree.JCTree.Tag.*;
