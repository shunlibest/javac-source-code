...
package comx.sun.tools.javac.file;
...
import comx.sun.tools.javac.file.RelativePath.RelativeDirectory;
import comx.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized comx.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            comx.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return comx.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            comx.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private comx.sun.tools.javac.util.List<String> zipFileEntriesFiles = comx.sun.tools.javac.util.List.<String>nil();
        private comx.sun.tools.javac.util.List<String> zipFileEntriesDirectories = comx.sun.tools.javac.util.List.<String>nil();
        private comx.sun.tools.javac.util.List<Entry>  zipFileEntries = comx.sun.tools.javac.util.List.<Entry>nil();
        ...
        private comx.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private comx.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private comx.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = comx.sun.tools.javac.util.List.nil();
