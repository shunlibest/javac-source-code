...
package comx.sun.tools.javac.processing;
...
import comx.sun.source.util.TaskEvent;
import comx.sun.tools.javac.api.BasicJavacTask;
import comx.sun.tools.javac.api.JavacTrees;
import comx.sun.tools.javac.api.MultiTaskListener;
import comx.sun.tools.javac.code.*;
import comx.sun.tools.javac.code.Symbol.*;
import comx.sun.tools.javac.file.FSInfo;
import comx.sun.tools.javac.file.JavacFileManager;
import comx.sun.tools.javac.jvm.*;
import comx.sun.tools.javac.jvm.ClassReader.BadClassFile;
import comx.sun.tools.javac.main.JavaCompiler;
import comx.sun.tools.javac.model.JavacElements;
import comx.sun.tools.javac.model.JavacTypes;
import comx.sun.tools.javac.parser.*;
...
import comx.sun.tools.javac.util.ClientCodeException;
import comx.sun.tools.javac.util.Context;
import comx.sun.tools.javac.util.Convert;
import comx.sun.tools.javac.util.JCDiagnostic;
import comx.sun.tools.javac.util.JavacMessages;
...
import comx.sun.tools.javac.util.ServiceLoader;
import static comx.sun.tools.javac.code.Lint.LintCategory.PROCESSING;
import static comx.sun.tools.javac.main.Option.*;
import static comx.sun.tools.javac.comp.CompileStates.CompileState;
import static comx.sun.tools.javac.util.JCDiagnostic.DiagnosticFlag.*;
