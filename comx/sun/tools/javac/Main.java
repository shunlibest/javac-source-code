...
public class Main {
    ...
    public static int compile(String[] args) {
        comx.sun.tools.javac.main.Main compiler =
            new comx.sun.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        comx.sun.tools.javac.main.Main compiler =
            new comx.sun.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
