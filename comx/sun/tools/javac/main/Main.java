...
import comx.sun.source.util.Plugin;
import comx.sun.tools.doclint.DocLint;
import comx.sun.tools.javac.api.BasicJavacTask;
import comx.sun.tools.javac.code.Source;
import comx.sun.tools.javac.file.CacheFSInfo;
import comx.sun.tools.javac.file.JavacFileManager;
import comx.sun.tools.javac.jvm.Profile;
import comx.sun.tools.javac.jvm.Target;
import comx.sun.tools.javac.processing.AnnotationProcessingError;
import comx.sun.tools.javac.processing.JavacProcessingEnvironment;
import comx.sun.tools.javac.util.*;
import comx.sun.tools.javac.util.Log.PrefixKind;
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "comx.sun.tools.javac.Main";
            showClass(showClass);
        }
...
//    }
    ...
    public static final String javacBundleName =
        "comx.sun.tools.javac.resources.javac";
//
