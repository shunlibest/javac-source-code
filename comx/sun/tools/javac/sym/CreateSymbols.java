...
package comx.sun.tools.javac.sym;

import comx.sun.tools.javac.api.JavacTaskImpl;
import comx.sun.tools.javac.code.Kinds;
import comx.sun.tools.javac.code.Scope;
import comx.sun.tools.javac.code.Symbol.*;
import comx.sun.tools.javac.code.Symbol;
import comx.sun.tools.javac.code.Attribute;
import comx.sun.tools.javac.code.Symtab;
import comx.sun.tools.javac.code.Type;
import comx.sun.tools.javac.code.Types;
import comx.sun.tools.javac.jvm.ClassWriter;
import comx.sun.tools.javac.jvm.Pool;
 ...
 *
 * <dl>
 * <dt>comx.sun.tools.javac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>comx.sun.tools.javac.sym.Dest</dt>
 ...
 */
@SupportedOptions({
    "comx.sun.tools.javac.sym.Jar",
    "comx.sun.tools.javac.sym.Dest",
    "comx.sun.tools.javac.sym.Profiles"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("comx.sun.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = pOptions.get("comx.sun.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Acomx.sun.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = pOptions.get("comx.sun.tools.javac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Acomx.sun.tools.javac.sym.Dest=LOCATION_OF_JAR");
        String profileSpec=pOptions.get("comx.sun.tools.javac.sym.Profiles");
        if (profileSpec == null)
            throw new RuntimeException("Must use -Acomx.sun.tools.javac.sym.Profiles=PROFILES_SPEC");
        ...
        comx.sun.tools.javac.main.JavaCompiler compiler =
            comx.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "comx.sun.tools.javac.sym.CreateSymbols",
            "-Acomx.sun.tools.javac.sym.Jar=" + rt_jar,
            "-Acomx.sun.tools.javac.sym.Dest=" + dest,
            ...
            "org.w3c.dom.views",
            "comx.sun.management",
            "comx.sun.security.auth",
            "comx.sun.security.auth.callback",
            "comx.sun.security.auth.login",
            "comx.sun.security.auth.module",
            "comx.sun.security.jgss",
            "comx.sun.net.httpserver",
            "comx.sun.net.httpserver.spi",
            "javax.smartcardio"
            // </editor-fold>
        };
        comx.sun.tools.javac.Main.compile(args);
    }
