...
package comx.sun.tools.javac.jvm;
...
import static comx.sun.tools.javac.jvm.ByteCodes.*;
import static comx.sun.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new comx.sun.tools.javac.model.FilteredMemberList(clazz.members())) {
